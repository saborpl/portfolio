...
$sql = "SELECT DISTINCT * from ogloszenia WHERE publikacja = 1 AND (lower(tytul) LIKE '%$s%' OR lower(opis) LIKE '%$s%') ORDER BY id DESC";
$ogloszenia = Yii::app()->db->createCommand($sql)->queryAll();
