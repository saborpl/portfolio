...
<div class="flash-notice">Musisz się <? echo CHtml::link('zarejestrować',array('/user/registration'), array('class'=>'member')); ?> lub <? echo CHtml::link('zalogować',array('/user/login'), array('class'=>'member')); ?> aby dodać ogłoszenie!</div>
